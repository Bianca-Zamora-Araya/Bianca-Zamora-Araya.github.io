...
/* Caja para contenido, PDF o texto */
.media-box {
  position: relative;
  width: 100%;
  height: clamp(320px, 45vw, 560px); /* altura mínima, relativa y máxima */
  border-radius: 8px;
  overflow: hidden;
  background: #f2f2f2; /* color de fondo por si tarda en cargar */
  padding: 1rem; /* espacio interno para texto */
  box-sizing: border-box;
}

/* Iframes ocupan toda la caja */
.media-box iframe {
  position: absolute;
  inset: 0;
  width: 100%;
...
<div class="pdf-grid">
  <div class="pdf-card">
    <h3>Pauta Trabajo Dirigido 1</h3>
    <iframe src="https://drive.google.com/file/d/1EqZLP_4WdAigpvutqYuIHQ73PemeWktm/view?usp=sharing#toolbar=0&navpanes=0&scrollbar=1"></iframe>
  </div>
</div>
...
<div class="pdf-grid">
  <div class="pdf-card">
    <h3>Pauta Trabajo Dirigido 1</h3>
    <iframe src="https://drive.google.com/file/d/1EqZLP_4WdAigpvutqYuIHQ73PemeWktm/view?usp=sharing"></iframe>
  </div>
</div>
...
<div class="pdf-grid">
  <div class="pdf-card">
    <h3>Pauta Trabajo Dirigido 1</h3>
    <iframe src="https://drive.google.com/file/d/1EqZLP_4WdAigpvutqYuIHQ73PemeWktm/view?usp=drive_link"></iframe>
  </div>
</div>
